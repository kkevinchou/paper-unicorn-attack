...
function PaperGameEngine () {
    ...
    self.cargo = new cargoModule.Cargo(self, 0, self.canvasHeight/2, 20 / 1000, 0);
...
PaperGameEngine.prototype.generateClouds = function (count) {
    ...
    for (var i=0; i<count; i++) {
    	...
    	var cloud = new cloudModule.Cloud(self, 0, y, speedX, 0);
    	cloud.setCloudSize(Math.floor(Math.random()*6) + 1);
    	cloud.resetX();
