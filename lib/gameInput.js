...
sys.inherits(ControllerConnection, events.EventEmitter);

ControllerConnection.prototype.reRegister = function()
{
    var self = this;
...
ControllerConnection.prototype.getMagnitude = function()    // 0.0 -> 1.0
{
    ...
    var magnitude = Math.min(150, self.magnitude);
    magnitude = Math.max(0, magnitude);
    return magnitude / 150.0;
};
...
ControllerConnection.prototype.sendTapResult = function(result) {
    var self = this;

    self.socket.emit('tap', {result: result});
};
